...
public class BlueEspectro2 : EnemyPath
{
    //Creating variables
    ...
    public override void CheckDistance()
    {
        ...
        */
            ...
            ChaseRadius && Vector3.Distance(Target.position, transform.position) > AttackRadius)
        {
            ...
            {
                Vector3 temp = Vector3.MoveTowards(transform.position, GridBlue2.PatrolBlue2[0].worldPosition, MoveSpeed * Time.deltaTime * 2);
